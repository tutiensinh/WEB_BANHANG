...
<html lang="vi">
    <head>
        <title>Kết quả tra cứu - NinhBinhStore</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
        <link rel="stylesheet" href="css/style.css">
    </head>
    <body>
        <jsp:include page="header.jsp"><jsp:param name="title" value="Kết quả tra cứu"/></jsp:include>

            <main class="container my-5" style="max-width: 900px;">
                <h2 class="fw-bold mb-4">Đơn hàng tìm thấy cho Email: "${searchTerm}"</h2>
            ...
            <c:choose>
                ...
                <c:when test="${empty orders}">
                    <div class="alert alert-warning text-center p-5">
                        ...
                        <a href="OrderLookupServlet" class="btn btn-primary mt-2">Thử lại</a>
                    </div>
                </c:when>
                            ...
                            <div class="accordion-item shadow-sm mb-3 border-0">
                                ...
                                <div id="collapse${order.id}" class="accordion-collapse collapse ${loop.first ? 'show' : ''}" 
                                    ...
                                    <div class="accordion-body">
                                        <p><strong>Khách hàng:</strong> ${order.hoten} (${order.email})</p>
